...
AArch64LegalizerInfo::AArch64LegalizerInfo(const AArch64Subtarget &ST)
  ...
  getActionDefinitionsBuilder(G_STORE)
    ...
    {nxv16s8, p0, nxv16s8, 8}, {nxv8s16, p0, nxv8s16, 8},
        {nxv4s32, p0, nxv4s32, 8}, {nxv2s64, p0, nxv2s64, 8},
        // SVE vscale x 64 bit base sizes
        {nxv4s16, p0, nxv4s16, 8}, {nxv2s32, p0, nxv2s32, 8},
        .clampScalar(0, s8, s64)
            ...
            .bitcastIf(typeInSet(0, {v4s8}),
                       [=](const LegalityQuery &Query) {
                         const LLT VecTy = Query.Types[0];
                         return std::pair(0,
                                          LLT::scalar(VecTy.getSizeInBits()));
                       })
            .customIf(IsPtrVecPred)
            .scalarizeIf(typeInSet(0, {v2s16, v2s8}), 0)
            .scalarizeIf(scalarOrEltWiderThan(0, 64), 0);
    ...
    getActionDefinitionsBuilder(G_ICMP)
        ...
        .minScalarOrEltIf(
            ...
            1, s32)
        .minScalarOrEltIf(
            [=](const LegalityQuery &Query) { return Query.Types[1] == v2p0; },
            0, s64)
